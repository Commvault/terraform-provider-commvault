...
func resourceAzureProtectionGroup() *schema.Resource {
    return &schema.Resource{
        Create: resourceCreateAzureProtectionGroup,
        Read:   resourceReadAzureProtectionGroup,
        Update: resourceUpdateAzureProtectionGroup,
        Delete: resourceDeleteAzureProtectionGroup,
...
func resourceCreateAzureProtectionGroup(d *schema.ResourceData, m interface{}) error {
    ...
    if val, ok := d.GetOk("cloudconnection"); ok {
        t_cloudconnection = build_azureprotectiongroup_msgidname(d, val.([]interface{}))
    }
    var t_workloads []handler.MsgProtectionGroupWorkloadSet
    if val, ok := d.GetOk("workloads"); ok {
        t_workloads = build_azureprotectiongroup_msgprotectiongroupworkloadset_array(d, val.(*schema.Set).List())
    }
    ...
    if val, ok := d.GetOk("content"); ok {
        t_content = build_azureprotectiongroup_msgrulegroupcontentset_array(d, val.(*schema.Set).List())
    }
    var t_contentfilter []handler.MsgRuleGroupContentSet
    if val, ok := d.GetOk("contentfilter"); ok {
        t_contentfilter = build_azureprotectiongroup_msgrulegroupcontentset_array(d, val.(*schema.Set).List())
    }
    var t_cloudaccounts []handler.MsgCloudAccountSet
    if val, ok := d.GetOk("cloudaccounts"); ok {
        t_cloudaccounts = build_azureprotectiongroup_msgcloudaccountset_array(d, val.(*schema.Set).List())
    }
    ...
    if val, ok := d.GetOk("awsaccountdiscoverydetails"); ok {
        t_awsaccountdiscoverydetails = build_azureprotectiongroup_msgawsorganizationaccountdiscoverydetails(d, val.([]interface{}))
    }
    var t_name *string
    ...
    if val, ok := d.GetOk("deleteactions"); ok {
        t_deleteactions = build_azureprotectiongroup_msgworkloadprotectiongroupdeletesettings(d, val.([]interface{}))
    }
    var t_filterworkloads []handler.MsgProtectionGroupWorkloadSet
    if val, ok := d.GetOk("filterworkloads"); ok {
        t_filterworkloads = build_azureprotectiongroup_msgprotectiongroupworkloadset_array(d, val.(*schema.Set).List())
    }
    var t_plan *handler.MsgIdName
    if val, ok := d.GetOk("plan"); ok {
        t_plan = build_azureprotectiongroup_msgidname(d, val.([]interface{}))
    }
    ...
    var req = handler.MsgCreateProtectionGroupRequest{CloudConnection:t_cloudconnection, Workloads:t_workloads, AllCloudAccounts:t_allcloudaccounts, Type:t_type, Content:t_content, ContentFilter:t_contentfilter, CloudAccounts:t_cloudaccounts, AwsAccountDiscoveryDetails:t_awsaccountdiscoverydetails, Name:t_name, DeleteActions:t_deleteactions, FilterWorkloads:t_filterworkloads, Plan:t_plan, BackupOnPostCreation:t_backuponpostcreation}
    resp, err := handler.CvCreateProtectionGroup(req)
    if err != nil {
        return fmt.Errorf("operation [CreateProtectionGroup] failed, Error %s", err)
    }
    if resp.Id != nil {
        response_id = strconv.Itoa(*resp.Id)
    }
    if response_id == "0" {
        return fmt.Errorf("operation [CreateProtectionGroup] failed")
    } else {
        d.SetId(response_id)
        return resourceCreateUpdateAzureProtectionGroup(d, m)
    }
}

func resourceReadAzureProtectionGroup(d *schema.ResourceData, m interface{}) error {
...
func resourceUpdateAzureProtectionGroup(d *schema.ResourceData, m interface{}) error {
    ...
    if d.HasChange("filtercontent") {
        ...
        t_filtercontent = build_azureprotectiongroup_msgrulegroupcontentset_array(d, val.(*schema.Set).List())
    }
    var t_workloads []handler.MsgProtectionGroupWorkloadSet
    ...
    if d.HasChange("protectiongroup") {
        ...
        t_protectiongroup = build_azureprotectiongroup_msgidname(d, val.([]interface{}))
    }
    var t_cloudaccounts []handler.MsgCloudAccountSet
    ...
    return resourceReadAzureProtectionGroup(d, m)
}

func resourceCreateUpdateAzureProtectionGroup(d *schema.ResourceData, m interface{}) error {
    //API: (PUT) /V4/ProtectionGroup/{protectionGroupId}
...
func resourceDeleteAzureProtectionGroup(d *schema.ResourceData, m interface{}) error {
...
func build_azureprotectiongroup_msgidname(d *schema.ResourceData, r []interface{}) *handler.MsgIdName {
    if len(r) > 0 && r[0] != nil {
...
func build_azureprotectiongroup_msgrulegroupcontentset_array(d *schema.ResourceData, r []interface{}) []handler.MsgRuleGroupContentSet {
    if r != nil {
        ...
        for a, iter_a := range r {
            ...
            if val, ok := raw_a["guestcredentials"]; ok {
                t_guestcredentials = build_azureprotectiongroup_msgvmguestcredentials(d, val.([]interface{}))
            }
            ...
            if val, ok := raw_a["rules"]; ok {
                t_rules = build_azureprotectiongroup_msgrulecontentset_array(d, val.(*schema.Set).List())
            }
            var t_existingcredential *handler.MsgVMExistingCredential
            if val, ok := raw_a["existingcredential"]; ok {
                t_existingcredential = build_azureprotectiongroup_msgvmexistingcredential(d, val.([]interface{}))
            }
...
func build_azureprotectiongroup_msgvmexistingcredential(d *schema.ResourceData, r []interface{}) *handler.MsgVMExistingCredential {
    if len(r) > 0 && r[0] != nil {
        tmp := r[0].(map[string]interface{})
...
func build_azureprotectiongroup_msgrulecontentset_array(d *schema.ResourceData, r []interface{}) []handler.MsgRuleContentSet {
    if r != nil {
...
func build_azureprotectiongroup_msgvmguestcredentials(d *schema.ResourceData, r []interface{}) *handler.MsgVMGuestCredentials {
    if len(r) > 0 && r[0] != nil {
        tmp := r[0].(map[string]interface{})
...
func build_azureprotectiongroup_msgprotectiongroupworkloadset_array(d *schema.ResourceData, r []interface{}) []handler.MsgProtectionGroupWorkloadSet {
    if r != nil {
        ...
        for a, iter_a := range r {
            ...
            if val, ok := raw_a["workloadoptions"]; ok {
                t_workloadoptions = build_azureprotectiongroup_msgworkloadoptions(d, val.([]interface{}))
            }
            var t_solution *handler.MsgIdName
            if val, ok := raw_a["solution"]; ok {
                t_solution = build_azureprotectiongroup_msgidname(d, val.([]interface{}))
            }
            var t_workload *handler.MsgIdName
            if val, ok := raw_a["workload"]; ok {
                t_workload = build_azureprotectiongroup_msgidname(d, val.([]interface{}))
            }
...
func build_azureprotectiongroup_msgworkloadoptions(d *schema.ResourceData, r []interface{}) *handler.MsgWorkloadOptions {
    if len(r) > 0 && r[0] != nil {
        tmp := r[0].(map[string]interface{})
        ...
        if val, ok := tmp["credential"]; ok {
            t_credential = build_azureprotectiongroup_msgidname(d, val.([]interface{}))
        }
...
func build_azureprotectiongroup_msgworkloadprotectiongroupdeletesettings(d *schema.ResourceData, r []interface{}) *handler.MsgWorkloadProtectionGroupDeleteSettings {
    if len(r) > 0 && r[0] != nil {
        tmp := r[0].(map[string]interface{})
...
func build_azureprotectiongroup_msgawsorganizationaccountdiscoverydetails(d *schema.ResourceData, r []interface{}) *handler.MsgAWSOrganizationAccountDiscoveryDetails {
    if len(r) > 0 && r[0] != nil {
        tmp := r[0].(map[string]interface{})
        ...
        if val, ok := tmp["accountaccessnodes"]; ok {
            t_accountaccessnodes = build_azureprotectiongroup_msgaccessnodeitemset_array(d, val.(*schema.Set).List())
        }
...
func build_azureprotectiongroup_msgaccessnodeitemset_array(d *schema.ResourceData, r []interface{}) []handler.MsgAccessNodeItemSet {
    if r != nil {
...
func build_azureprotectiongroup_msgcloudaccountset_array(d *schema.ResourceData, r []interface{}) []handler.MsgCloudAccountSet {
    if r != nil {
