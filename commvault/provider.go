...
func Provider() *schema.Provider {
	return &schema.Provider{
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"commvault_credential_aws":                       resourceCredential_AWS(),			"commvault_vmgroup_v2":                           resourceVMGroup_V2(),
			"commvault_credential_awswithrolearn":            resourceCredential_AWSWithRoleArn(),			"commvault_oracle_instance":                      resourceOracleInstance(),
