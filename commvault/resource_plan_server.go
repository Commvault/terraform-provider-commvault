                ...
                Elem: &schema.Resource{
                    Schema: map[string]*schema.Schema{
                        ...
                        "backupstocopy": {
                            Type:        schema.TypeString,
                            Optional:    true,
                            Description: "[All_JOBS, ALL_FULLS, HOURLY_FULLS, DAILY_FULLS, WEEKLY_FULLS, MONTHLY_FULLS, QUARTERLY_FULLS, HALF_YEARLY_FULLS, YEARLY_FULLS, ADVANCED]",
                        },
                            ...
                            Elem: &schema.Resource{
                                Schema: map[string]*schema.Schema{
                                    "vendor": {
                                        Type:        schema.TypeString,
                                        Optional:    true,
                                        Description: "Snapshot vendors available for Snap Copy mappings [NETAPP, AMAZON]",
                                    },
                                    "targetvendor": {
                                        Type:        schema.TypeList,
                                        Optional:    true,
...
func serialize_plan_server_msgplancontent(d *schema.ResourceData, data *handler.MsgPlanContent) ([]map[string]interface{}, bool) {
    ...
    if data.UnixIncludedPaths != nil {
        val[0]["unixincludedpaths"] = data.UnixIncludedPaths
        added = true
    }
    if data.MacExcludedPaths != nil {
        val[0]["macexcludedpaths"] = data.MacExcludedPaths
        added = true
    }
    if data.MacFilterToExcludePaths != nil {
        val[0]["macfiltertoexcludepaths"] = data.MacFilterToExcludePaths
        added = true
    }
    if data.MacIncludedPaths != nil {
        val[0]["macincludedpaths"] = data.MacIncludedPaths
        added = true
    }
    if data.UnixExcludedPaths != nil {
        val[0]["unixexcludedpaths"] = data.UnixExcludedPaths
        added = true
    }
    ...
    if data.UnixFilterToExcludePaths != nil {
        val[0]["unixfiltertoexcludepaths"] = data.UnixFilterToExcludePaths
        added = true
    }
