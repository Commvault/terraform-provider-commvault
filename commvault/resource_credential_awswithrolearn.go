...
func resourceCreateCredential_AWSWithRoleArn(d *schema.ResourceData, m interface{}) error {
    ...
    if val, ok := d.GetOk("security"); ok {
        t_security = build_credential_awswithrolearn_msgcredentialsecurity(d, val.([]interface{}))
    }
    var t_description *string
    if val, ok := d.GetOk("description"); ok {
        t_description = handler.ToStringValue(val, false)
    }
    var req = handler.MsgCreateCredentialAWSWithRoleArnRequest{VendorType:t_vendortype, AccountType:t_accounttype, Name:t_name, Password:t_password, RoleArn:t_rolearn, AuthType:t_authtype, Security:t_security, Description:t_description}
...
func resourceReadCredential_AWSWithRoleArn(d *schema.ResourceData, m interface{}) error {
    ...
    resp, err := handler.CvGetCredentailDetailsAWSWithRoleArn(d.Id())
    if err != nil {
        return fmt.Errorf("operation [GetCredentailDetailsAWSWithRoleArn] failed, Error %s", err)
    }
    ...
    if rtn, ok := serialize_credential_awswithrolearn_msgcredentialsecurity(d, resp.Security); ok {
        d.Set("security", rtn)
    } else {
...
func resourceUpdateCredential_AWSWithRoleArn(d *schema.ResourceData, m interface{}) error {
    ...
    if val, ok := d.GetOk("security"); ok {
        t_security = build_credential_awswithrolearn_msgupdatecredentialsecurity(d, val.([]interface{}))
    }
    ...
    var req = handler.MsgUpdateCredentialAWSWithRoleArnRequest{Password:t_password, Security:t_security, NewName:t_newname, RoleArn:t_rolearn, Description:t_description}
...
func build_credential_awswithrolearn_msgupdatecredentialsecurity(d *schema.ResourceData, r []interface{}) *handler.MsgUpdateCredentialSecurity {
    if len(r) > 0 && r[0] != nil {
        tmp := r[0].(map[string]interface{})
        var t_owner *handler.MsgCredentialOwner
        if val, ok := tmp["owner"]; ok {
            t_owner = build_credential_awswithrolearn_msgcredentialowner(d, val.([]interface{}))
        }
        var t_associations []handler.MsgCredentialSecurityAssociationsSet
        if val, ok := tmp["associations"]; ok {
            t_associations = build_credential_awswithrolearn_msgcredentialsecurityassociationsset_array(d, val.(*schema.Set).List())
        }
...
func build_credential_awswithrolearn_msgcredentialsecurityassociationsset_array(d *schema.ResourceData, r []interface{}) []handler.MsgCredentialSecurityAssociationsSet {
    if r != nil {
        ...
        for a, iter_a := range r {
            ...
            if val, ok := raw_a["permissions"]; ok {
                t_permissions = build_credential_awswithrolearn_msgpermissionresp(d, val.([]interface{}))
            }
            var t_user *handler.MsgIdName
            if val, ok := raw_a["user"]; ok {
                t_user = build_credential_awswithrolearn_msgidname(d, val.([]interface{}))
            }
            var t_usergroup *handler.MsgIdName
            if val, ok := raw_a["usergroup"]; ok {
                t_usergroup = build_credential_awswithrolearn_msgidname(d, val.([]interface{}))
            }
...
func build_credential_awswithrolearn_msgidname(d *schema.ResourceData, r []interface{}) *handler.MsgIdName {
    if len(r) > 0 && r[0] != nil {
        tmp := r[0].(map[string]interface{})
        var t_id *int
        if val, ok := tmp["id"]; ok {
...
func build_credential_awswithrolearn_msgpermissionresp(d *schema.ResourceData, r []interface{}) *handler.MsgPermissionResp {
    if len(r) > 0 && r[0] != nil {
        tmp := r[0].(map[string]interface{})
...
func build_credential_awswithrolearn_msgcredentialowner(d *schema.ResourceData, r []interface{}) *handler.MsgCredentialOwner {
    if len(r) > 0 && r[0] != nil {
        tmp := r[0].(map[string]interface{})
        var t_user *handler.MsgIdName
...
func build_credential_awswithrolearn_msgcredentialsecurity(d *schema.ResourceData, r []interface{}) *handler.MsgCredentialSecurity {
    if len(r) > 0 && r[0] != nil {
        tmp := r[0].(map[string]interface{})
        var t_owner *handler.MsgCredentialOwner
        if val, ok := tmp["owner"]; ok {
...
func serialize_credential_awswithrolearn_msgcredentialsecurity(d *schema.ResourceData, data *handler.MsgCredentialSecurity) ([]map[string]interface{}, bool) {
    ...
    added := false
    if rtn, ok := serialize_credential_awswithrolearn_msgcredentialowner(d, data.Owner); ok {
        val[0]["owner"] = rtn
        added = true
    }
    if rtn, ok := serialize_credential_awswithrolearn_msgcredentialsecurityassociationsset_array(d, data.Associations); ok {
...
func serialize_credential_awswithrolearn_msgcredentialsecurityassociationsset_array(d *schema.ResourceData, data []handler.MsgCredentialSecurityAssociationsSet) ([]map[string]interface{}, bool) {
    ...
    for i := range data {
        ...
        if rtn, ok := serialize_credential_awswithrolearn_msgpermissionresp(d, data[i].Permissions); ok {
            tmp["permissions"] = rtn
            added = true
        }
        if rtn, ok := serialize_credential_awswithrolearn_msgidname(d, data[i].User); ok {
            tmp["user"] = rtn
            added = true
        }
        if rtn, ok := serialize_credential_awswithrolearn_msgidname(d, data[i].UserGroup); ok {
            tmp["usergroup"] = rtn
            added = true
        }
        if added {
...
func serialize_credential_awswithrolearn_msgidname(d *schema.ResourceData, data *handler.MsgIdName) ([]map[string]interface{}, bool) {
...
func serialize_credential_awswithrolearn_msgpermissionresp(d *schema.ResourceData, data *handler.MsgPermissionResp) ([]map[string]interface{}, bool) {
...
func serialize_credential_awswithrolearn_msgcredentialowner(d *schema.ResourceData, data *handler.MsgCredentialOwner) ([]map[string]interface{}, bool) {
    ...
    val[0] = make(map[string]interface{})
    added := false
    if rtn, ok := serialize_credential_awswithrolearn_msgidname(d, data.User); ok {
        val[0]["user"] = rtn
        added = true
    }
    if rtn, ok := serialize_credential_awswithrolearn_msgidname(d, data.UserGroup); ok {
        val[0]["usergroup"] = rtn
        added = true
    }
    if added {
