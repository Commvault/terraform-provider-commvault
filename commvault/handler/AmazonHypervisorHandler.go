...
func AmazonHypCreateHandler(clientName string, regions string, useIAMrole bool, accessKey string, secretKey string, accessNodes string, companyID int) *AppCreatePseudoClientResponse {
	...
	if useIAMrole {
		...
		amazonInstanceInfo.RegionEndPoints = regions
		amazonInstanceInfo.UseIamRole = "0"
		appCreatePseudoClientReq.ClientInfo.VirtualServerClientProperties.VirtualServerInstanceInfo.VmwareVendor.VcenterHostName = regions
	}
