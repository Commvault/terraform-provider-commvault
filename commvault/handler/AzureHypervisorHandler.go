...
func AzureHypCreateHandler(displayName string, subscriptionID string, tenantID string, applicationID string, applicationPWD string, accessNodes string, companyID int) *AppCreatePseudoClientResponse {
