...
type MsgCreateServerGroupsRequest struct {
    VirtualAssociation       *MsgVirtualServerGroupAssociationDetails `json:"virtualAssociation,omitempty"`
    AutomaticAssociation     *MsgAutomaticServerGroupAssociationDetails `json:"automaticAssociation,omitempty"`
    Name                     *string `json:"name,omitempty"`
    GlobalConfigInfo         *MsgCreateGlobalConfigInfo `json:"globalConfigInfo,omitempty"`
    Description              *string `json:"description,omitempty"`
    ManualAssociation        *MsgManualServerGroupAssociationDetails `json:"manualAssociation,omitempty"`
    ServerGroupType          *string `json:"serverGroupType,omitempty"`
}

type MsgVirtualServerGroupAssociationDetails struct {
    ClientAssociation[]   MsgclientAssociationServerGroupContentSet `json:"clientAssociation,omitempty"`
    VirtualServers[]      MsgIdNameSet `json:"virtualServers,omitempty"`
    Rules                 *MsgRuleGroupContent `json:"rules,omitempty"`
    VirtualInstance       *string `json:"virtualInstance,omitempty"`
}

type MsgclientAssociationServerGroupContentSet struct {
    AssociationRule[]    MsgVirtualMachinecontentSet `json:"associationRule,omitempty"`
    AssociatedClient     *MsgassociatedClientId `json:"associatedClient,omitempty"`
}
...
type MsgassociatedClientId struct {
    ClientID     *int `json:"clientID,omitempty"`
}

type MsgRuleGroupContent struct {
...
type MsgAutomaticServerGroupAssociationDetails struct {
    ServerGroupRule       *MsgServerRuleGroups `json:"serverGroupRule,omitempty"`
    ConfirmRuleChange     *bool `json:"confirmRuleChange,omitempty"`
    ServerGroupId         *int `json:"serverGroupId,omitempty"`
    ClientScope           *MsgClientScopeDetails `json:"clientScope,omitempty"`
}

type MsgServerRuleGroups struct {
    Match         *string `json:"match,omitempty"`
    RuleGroup[]   MsgServerRuleGroupSet `json:"ruleGroup,omitempty"`
}

type MsgServerRuleGroupSet struct {
    Match     *string `json:"match,omitempty"`
    Rules[]   MsgServerRuleSet `json:"rules,omitempty"`
}

type MsgServerRuleSet struct {
...
type MsgClientScopeDetails struct {
    EntityInfo          *MsgIdNameGUID `json:"entityInfo,omitempty"`
    ClientScopeType     *string `json:"clientScopeType,omitempty"`
}

type MsgIdNameGUID struct {
    GUID     *string `json:"GUID,omitempty"`
    Name     *string `json:"name,omitempty"`
    Id       *int `json:"id,omitempty"`
}

type MsgCreateGlobalConfigInfo struct {
    ScopeFilterQuery        *string `json:"scopeFilterQuery,omitempty"`
    Companies[]             MsgGlobalConfigCompanyInfoSet `json:"companies,omitempty"`
    ApplyOnAllCommCells     *bool `json:"applyOnAllCommCells,omitempty"`
    Commcells[]             MsgGlobalConfigCommcellInfoSet `json:"commcells,omitempty"`
    Scope                   *string `json:"scope,omitempty"`
    Name                    *string `json:"name,omitempty"`
    ApplyOnAllCompanies     *bool `json:"applyOnAllCompanies,omitempty"`
    ActionOnLocalEntity     *string `json:"actionOnLocalEntity,omitempty"`
}

type MsgGlobalConfigCompanyInfoSet struct {
    Name     *string `json:"name,omitempty"`
    Guid     *string `json:"guid,omitempty"`
    Id       *int `json:"id,omitempty"`
}

type MsgGlobalConfigCommcellInfoSet struct {
...
type MsgManualServerGroupAssociationDetails struct {
    Associatedservers[]   MsgIdNameSet `json:"associatedservers,omitempty"`
    OperationType         *string `json:"operationType,omitempty"`
}

type MsgCreateServerGroupsResponse struct {
    ServerGroupInfo     *MsgIdNameGUID `json:"serverGroupInfo,omitempty"`
}

type MsgGetServerGroupIdDetailsResponse struct {
    ActivityControl       *MsgactivityControl `json:"activityControl,omitempty"`
    General               *MsggeneralInfoServerGroup `json:"general,omitempty"`
    Security[]            MsgSecurityAssocSet `json:"security,omitempty"`
    FileExceptions        *MsgfileExceptionsDetail `json:"fileExceptions,omitempty"`
    BlackoutWindow[]      MsgblackoutWindowDetailsSet `json:"blackoutWindow,omitempty"`
    ServerGroup           *MsgIdName `json:"serverGroup,omitempty"`
    Description           *string `json:"description,omitempty"`
    AssociatedServers[]   MsgserverDetailsSet `json:"associatedServers,omitempty"`
    PowerManagement       *MsgIdName `json:"powerManagement,omitempty"`
}

type MsgactivityControl struct {
...
type MsggeneralInfoServerGroup struct {
...
type MsgfileExceptionsDetail struct {
...
type MsgblackoutWindowDetailsSet struct {
    DoNotSubmitJob       *bool `json:"doNotSubmitJob,omitempty"`
    BetweenDates         *bool `json:"betweenDates,omitempty"`
    DoNotRunJob[]        MsgdoNotRunJobDetailsSet `json:"doNotRunJob,omitempty"`
    EndDate              *int `json:"endDate,omitempty"`
    Name                 *string `json:"name,omitempty"`
    BackupOperations     *MsgbackupOperationsList `json:"backupOperations,omitempty"`
    StartDate            *int `json:"startDate,omitempty"`
}

type MsgdoNotRunJobDetailsSet struct {
    DayTimeEnd       *int `json:"dayTimeEnd,omitempty"`
    DayTimeStart     *int `json:"dayTimeStart,omitempty"`
    OfWeeks[]        string `json:"ofWeeks,omitempty"`
    OnDays[]         string `json:"onDays,omitempty"`
}

type MsgbackupOperationsList struct {
...
type MsgserverDetailsSet struct {
    Agent[]          MsgIdNameSet `json:"agent,omitempty"`
...
type MsgDeleteServerGroupResponse struct {
    ErrorMessage     *string `json:"errorMessage,omitempty"`
    ErrorCode        *int `json:"errorCode,omitempty"`
}

type MsgUpdateServerGroupAssociationRequest struct {
    VirtualAssociation       *MsgVirtualServerGroupAssociationDetails `json:"virtualAssociation,omitempty"`
    AutomaticAssociation     *MsgAutomaticServerGroupAssociationDetails `json:"automaticAssociation,omitempty"`
    ServerGroup              *MsgIdName `json:"serverGroup,omitempty"`
    Description              *string `json:"description,omitempty"`
...
type MsgUpdateServerGroupAssociationResponse struct {
    ErrorMessage     *string `json:"errorMessage,omitempty"`
    ErrorCode        *int `json:"errorCode,omitempty"`
}
...
type MsggetProtectionGroupPropertiesResponse struct {
    FilterQueryCount              *int `json:"filterQueryCount,omitempty"`
    ProtectionGroupProperties     *MsgWorkloadProtectionGroupProperties `json:"protectionGroupProperties,omitempty"`
}

type MsgWorkloadProtectionGroupProperties struct {
    ...
    Agent                *MsgIdName `json:"agent,omitempty"`
    Instance             *MsgIdName `json:"instance,omitempty"`
    CreationTime         *int `json:"creationTime,omitempty"`
    CloudConnection      *MsgIdName `json:"cloudConnection,omitempty"`
    FilterContent[]      MsgRuleGroupContentSet `json:"filterContent,omitempty"`
    Workloads[]          MsgProtectionGroupWorkloadSet `json:"workloads,omitempty"`
    Backupset            *MsgIdName `json:"backupset,omitempty"`
    ServerGroup          *MsgIdName `json:"serverGroup,omitempty"`
    TimeZone             *MsgIdName `json:"timeZone,omitempty"`
    AllCloudAccounts     *bool `json:"allCloudAccounts,omitempty"`
    Content[]            MsgRuleGroupContentSet `json:"content,omitempty"`
    LastBackup           *MsgLastBackupJobInfo `json:"lastBackup,omitempty"`
    CloudAccounts[]      MsgCloudAccountSet `json:"cloudAccounts,omitempty"`
    Name                 *string `json:"name,omitempty"`
    DeleteActions        *MsgWorkloadProtectionGroupDeleteSettings `json:"deleteActions,omitempty"`
    Company              *MsgcompanyInfo `json:"company,omitempty"`
    Id                   *int `json:"id,omitempty"`
    FilterWorkloads[]    MsgProtectionGroupWorkloadSet `json:"filterWorkloads,omitempty"`
    Plan                 *MsgIdName `json:"plan,omitempty"`
...
type MsgProtectionGroupWorkloadSet struct {
    WorkloadOptions     *MsgWorkloadOptions `json:"workloadOptions,omitempty"`
    Solution            *MsgIdName `json:"solution,omitempty"`
    Workload            *MsgIdName `json:"workload,omitempty"`
}

type MsgWorkloadOptions struct {
    IsLongTermRetention     *bool `json:"isLongTermRetention,omitempty"`
    Credential              *MsgIdName `json:"credential,omitempty"`
    IsRapidRecovery         *bool `json:"isRapidRecovery,omitempty"`
}
...
type MsgCloudAccountSet struct {
    Name      *string `json:"name,omitempty"`
...
type MsgWorkloadProtectionGroupDeleteSettings struct {
    DeconfigureResources     *bool `json:"deconfigureResources,omitempty"`
    DecoupleResources        *bool `json:"decoupleResources,omitempty"`
}

type MsgcompanyInfo struct {
    Name                *string `json:"name,omitempty"`
    MultiCommcellId     *int `json:"multiCommcellId,omitempty"`
    Id                  *int `json:"id,omitempty"`
}

type MsgDeleteWorkloadProtectionGroupResponse struct {
    ErrorMessage     *string `json:"errorMessage,omitempty"`
    ErrorCode        *int `json:"errorCode,omitempty"`
}

type MsgUpdateWorkloadProtectionGroupRequest struct {
    ContentOperationType           *string `json:"contentOperationType,omitempty"`
    FilterContent[]                MsgRuleGroupContentSet `json:"filterContent,omitempty"`
    Workloads[]                    MsgProtectionGroupWorkloadSet `json:"workloads,omitempty"`
    AllCloudAccounts               *bool `json:"allCloudAccounts,omitempty"`
    CloudAccountsOperationType     *string `json:"cloudAccountsOperationType,omitempty"`
    Type                           *string `json:"type,omitempty"`
    Content[]                      MsgRuleGroupContentSet `json:"content,omitempty"`
    ProtectionGroup                *MsgIdName `json:"protectionGroup,omitempty"`
    CloudAccounts[]                MsgCloudAccountSet `json:"cloudAccounts,omitempty"`
    NewName                        *string `json:"newName,omitempty"`
    AwsAccountDiscoveryDetails     *MsgAWSOrganizationAccountDiscoveryDetails `json:"awsAccountDiscoveryDetails,omitempty"`
    DeleteActions                  *MsgWorkloadProtectionGroupDeleteSettings `json:"deleteActions,omitempty"`
    FilterContentOperationType     *string `json:"filterContentOperationType,omitempty"`
    FilterWorkloads[]              MsgProtectionGroupWorkloadSet `json:"filterWorkloads,omitempty"`
    Plan                           *MsgIdName `json:"plan,omitempty"`
}

type MsgAWSOrganizationAccountDiscoveryDetails struct {
    RoleNameWithPath           *string `json:"roleNameWithPath,omitempty"`
    AccountAccessNodes[]       MsgAccessNodeItemSet `json:"accountAccessNodes,omitempty"`
    BackupServiceAccountId     *string `json:"backupServiceAccountId,omitempty"`
}

type MsgAccessNodeItemSet struct {
    DisplayName        *string `json:"displayName,omitempty"`
    Name               *string `json:"name,omitempty"`
    Id                 *int `json:"id,omitempty"`
    AccessNodeType     *string `json:"accessNodeType,omitempty"`
}

type MsgUpdateWorkloadProtectionGroupResponse struct {
    Name     *string `json:"name,omitempty"`
    Id       *int `json:"id,omitempty"`
}

type MsgCreateProtectionGroupRequest struct {
    CloudConnection                *MsgIdName `json:"cloudConnection,omitempty"`
    Workloads[]                    MsgProtectionGroupWorkloadSet `json:"workloads,omitempty"`
    AllCloudAccounts               *bool `json:"allCloudAccounts,omitempty"`
    Type                           *string `json:"type,omitempty"`
    Content[]                      MsgRuleGroupContentSet `json:"content,omitempty"`
    ContentFilter[]                MsgRuleGroupContentSet `json:"contentFilter,omitempty"`
    CloudAccounts[]                MsgCloudAccountSet `json:"cloudAccounts,omitempty"`
    AwsAccountDiscoveryDetails     *MsgAWSOrganizationAccountDiscoveryDetails `json:"awsAccountDiscoveryDetails,omitempty"`
    Name                           *string `json:"name,omitempty"`
    DeleteActions                  *MsgWorkloadProtectionGroupDeleteSettings `json:"deleteActions,omitempty"`
    FilterWorkloads[]              MsgProtectionGroupWorkloadSet `json:"filterWorkloads,omitempty"`
    Plan                           *MsgIdName `json:"plan,omitempty"`
    BackupOnPostCreation           *bool `json:"backupOnPostCreation,omitempty"`
}

type MsgCreateProtectionGroupResponse struct {
    Name     *string `json:"name,omitempty"`
    Id       *int `json:"id,omitempty"`
}
...
type MsgGetKubernetesClusterDetailsResponse struct {
    ...
    CloudStorage         *MsgKubernetesCloudStorage `json:"cloudStorage,omitempty"`
...
type MsgKubernetesCloudStorage struct {
    Region          *MsgIdName `json:"region,omitempty"`
...
type MsgEditClusterAdvancedOptionsInfo struct {
    ...
    JobStepWaitTime     *MsgJobStepWaitTimeOptions `json:"jobStepWaitTime,omitempty"`
    ImageRegistry       *MsgClusterImageRegistryOptions `json:"imageRegistry,omitempty"`
}

type MsgJobStepWaitTimeOptions struct {
    SnapshotReady        *int `json:"snapshotReady,omitempty"`
    WorkerPodStartup     *int `json:"workerPodStartup,omitempty"`
    SnapshotCleanup      *int `json:"snapshotCleanup,omitempty"`
    ResourceCleanup      *int `json:"resourceCleanup,omitempty"`
}
...
type MsggetReplicationGroupDetailsAmazonRequest struct {
    Summary                      *MsgReplicationGroupSummary `json:"summary,omitempty"`
    Rpo                          *MsgRpo `json:"rpo,omitempty"`
    Name                         *string `json:"name,omitempty"`
    Id                           *int `json:"id,omitempty"`
    Storage                      *MsgReplicationGroupStorageList `json:"storage,omitempty"`
    Vendor                       *string `json:"vendor,omitempty"`
    AdvancedOption               *MsgReplicationGroupAdvOptionsAmazon `json:"advancedOption,omitempty"`
    ReplicationConfiguration[]   MsgReplicationConfigurationAmazonSet `json:"replicationConfiguration,omitempty"`
}

type MsgReplicationGroupSummary struct {
    RecoveryTarget        *string `json:"recoveryTarget,omitempty"`
    ReplicationType       *string `json:"replicationType,omitempty"`
    DestinationVendor     *string `json:"destinationVendor,omitempty"`
    Source                *string `json:"source,omitempty"`
    State                 *string `json:"state,omitempty"`
}

type MsgRpo struct {
    ReplicationFrequency     *int `json:"replicationFrequency,omitempty"`
}

type MsgReplicationGroupStorageList struct {
    Copies[]               MsgStorageCopySet `json:"copies,omitempty"`
    CopyForReplication     *string `json:"copyForReplication,omitempty"`
}

type MsgStorageCopySet struct {
    Name            *string `json:"name,omitempty"`
    StoragePool     *MsgIdName `json:"storagePool,omitempty"`
    Retention       *int `json:"retention,omitempty"`
}

type MsgReplicationGroupAdvOptionsAmazon struct {
    ...
    DeployVmWhenFailover       *bool `json:"deployVmWhenFailover,omitempty"`
    FailoverDelay              *int `json:"failoverDelay,omitempty"`
    UnconditionalOverwrite     *bool `json:"unconditionalOverwrite,omitempty"`
}

type MsgReplicationConfigurationAmazonSet struct {
    DestinationVM                  *string `json:"destinationVM,omitempty"`
    SourceVMGuid                   *string `json:"sourceVMGuid,omitempty"`
    OverrideReplicationOptions     *MsgOverrideReplicationOptionsAmazon `json:"overrideReplicationOptions,omitempty"`
    SourceVM                       *string `json:"sourceVM,omitempty"`
    TestFailoverInstanceType       *string `json:"testFailoverInstanceType,omitempty"`
    InstanceType                   *string `json:"instanceType,omitempty"`
    Datacenter                     *string `json:"datacenter,omitempty"`
    AvailabilityZone               *string `json:"availabilityZone,omitempty"`
}

type MsgOverrideReplicationOptionsAmazon struct {
    VolumeType                              *string `json:"volumeType,omitempty"`
    GuestCreds                              *MsgGuestCreds `json:"guestCreds,omitempty"`
    AutoSelectSecurityGroup                 *bool `json:"autoSelectSecurityGroup,omitempty"`
    TestFailoverSecurityGroups[]            MsgSecurityGroupSet `json:"testFailoverSecurityGroups,omitempty"`
    KeyPair                                 *string `json:"keyPair,omitempty"`
    SecurityGroups[]                        MsgSecurityGroupSet `json:"securityGroups,omitempty"`
    EncryptionKey                           *string `json:"encryptionKey,omitempty"`
    IAMRole                                 *MsgGuidName `json:"IAMRole,omitempty"`
    Network                                 *MsgAmazonNetwork `json:"network,omitempty"`
    TestFailoverNetwork                     *MsgAmazonNetwork `json:"testFailoverNetwork,omitempty"`
    AutoSelectTestFailoverSecurityGroup     *bool `json:"autoSelectTestFailoverSecurityGroup,omitempty"`
}

type MsgGuestCreds struct {
    Password         *string `json:"password,omitempty"`
    ComputerName     *string `json:"computerName,omitempty"`
    UserName         *string `json:"userName,omitempty"`
}

type MsgSecurityGroupSet struct {
    Name     *string `json:"name,omitempty"`
    Id       *string `json:"id,omitempty"`
}

type MsgGuidName struct {
    Name     *string `json:"name,omitempty"`
    Guid     *string `json:"guid,omitempty"`
}

type MsgAmazonNetwork struct {
...
type MsgCreateReplicationGroupAmazonRequest struct {
    RecoveryTarget                 *MsgIdName `json:"recoveryTarget,omitempty"`
    FrequencyInMinutes             *int `json:"frequencyInMinutes,omitempty"`
    Name                           *string `json:"name,omitempty"`
    Storage[]                      MsgStorageCopyCreateSet `json:"storage,omitempty"`
    SourceHypervisor               *MsgIdName `json:"sourceHypervisor,omitempty"`
    Vms[]                          MsgNameGUIDSet `json:"vms,omitempty"`
    OverrideReplicationOptions[]   MsgOverrideReplicationOptionsAmazonCreateSet `json:"overrideReplicationOptions,omitempty"`
    AdvancedOptions                *MsgReplicationGroupAdvOptionsAmazon `json:"advancedOptions,omitempty"`
    DestVendor                     *string `json:"destVendor,omitempty"`
}

type MsgStorageCopyCreateSet struct {
    IsDedupe        *bool `json:"isDedupe,omitempty"`
    StoragePool     *MsgIdName `json:"storagePool,omitempty"`
}

type MsgNameGUIDSet struct {
    GUID     *string `json:"GUID,omitempty"`
    Name     *string `json:"name,omitempty"`
}

type MsgOverrideReplicationOptionsAmazonCreateSet struct {
    VolumeType           *string `json:"volumeType,omitempty"`
    GuestCredentials     *MsgGuestCredentialsCreate `json:"guestCredentials,omitempty"`
    SourceVM             *MsgNameGUID `json:"sourceVM,omitempty"`
    ...
    EncryptionKey        *string `json:"encryptionKey,omitempty"`
    AvailabilityZone     *string `json:"availabilityZone,omitempty"`
    Network              *MsgNetworkVPCSubnet `json:"network,omitempty"`
}

type MsgGuestCredentialsCreate struct {
    Password         *string `json:"password,omitempty"`
    ComputerName     *string `json:"computerName,omitempty"`
    UserName         *string `json:"userName,omitempty"`
}

type MsgNameGUID struct {
    GUID     *string `json:"GUID,omitempty"`
    Name     *string `json:"name,omitempty"`
}

type MsgNetworkVPCSubnet struct {
    SubnetId             *string `json:"subnetId,omitempty"`
...
type MsgCreateReplicationGroupAmazonResponse struct {
    Name     *string `json:"name,omitempty"`
    Id       *int `json:"id,omitempty"`
}

type MsgModifyReplicationGroupRequest struct {
    NewName             *string `json:"newName,omitempty"`
    Enable              *bool `json:"enable,omitempty"`
    Disable             *bool `json:"disable,omitempty"`
    AdvancedOptions     *MsgReplicationGroupAdvancedOptions `json:"advancedOptions,omitempty"`
}

type MsgReplicationGroupAdvancedOptions struct {
    DelayBetweenPriorityMachines     *int `json:"delayBetweenPriorityMachines,omitempty"`
    ContinueOnFailure                *bool `json:"continueOnFailure,omitempty"`
    Script                           *MsgReplicationGroupScript `json:"script,omitempty"`
}

type MsgReplicationGroupScript struct {
    PreFailover      *MsgDROperationScript `json:"preFailover,omitempty"`
    PostFailover     *MsgDROperationScript `json:"postFailover,omitempty"`
    PreFailback      *MsgDROperationScript `json:"preFailback,omitempty"`
    PostFailback     *MsgDROperationScript `json:"postFailback,omitempty"`
}

type MsgDROperationScript struct {
    ScriptContent         *string `json:"scriptContent,omitempty"`
    Path                  *string `json:"path,omitempty"`
    GuestCredentials      *MsgguestCredentialInfo `json:"guestCredentials,omitempty"`
    ScriptCredentials     *MsgguestCredentialInfo `json:"scriptCredentials,omitempty"`
...
type MsgModifyReplicationGroupResponse struct {
    ErrorMessage     *string `json:"errorMessage,omitempty"`
    ErrorCode        *int `json:"errorCode,omitempty"`
}

type MsggetReplicationGroupDetailsAzureRequest struct {
    Summary                      *MsgReplicationGroupSummary `json:"summary,omitempty"`
    Rpo                          *MsgRpo `json:"rpo,omitempty"`
    Name                         *string `json:"name,omitempty"`
    Id                           *int `json:"id,omitempty"`
    Storage                      *MsgReplicationGroupStorageList `json:"storage,omitempty"`
    Vendor                       *string `json:"vendor,omitempty"`
    AdvancedOption               *MsgReplicationGroupAdvOptionsAzure `json:"advancedOption,omitempty"`
    ReplicationConfiguration[]   MsgReplicationConfigurationAzureSet `json:"replicationConfiguration,omitempty"`
}

type MsgReplicationGroupAdvOptionsAzure struct {
    DeployVmOnlyDuringfailover     *bool `json:"deployVmOnlyDuringfailover,omitempty"`
    UnconditionalOverwrite         *bool `json:"unconditionalOverwrite,omitempty"`
}

type MsgReplicationConfigurationAzureSet struct {
    DestinationVM                  *string `json:"destinationVM,omitempty"`
    ResourceGroup                  *string `json:"resourceGroup,omitempty"`
    TestFailoverVmSize             *string `json:"testFailoverVmSize,omitempty"`
    SourceVM                       *string `json:"sourceVM,omitempty"`
    StorageAccount                 *string `json:"storageAccount,omitempty"`
    ExtensionRestorePolicy         *string `json:"extensionRestorePolicy,omitempty"`
    SourceVMGuid                   *string `json:"sourceVMGuid,omitempty"`
    OverrideReplicationOptions     *MsgOverrideReplicationOptionsAzure `json:"overrideReplicationOptions,omitempty"`
...
type MsgOverrideReplicationOptionsAzure struct {
    TestFailoverVirtualNetwork     *MsgAzureNetwork `json:"testFailoverVirtualNetwork,omitempty"`
    SecurityGroup                  *MsgSecurityGroup `json:"securityGroup,omitempty"`
    AvailabilityZone               *string `json:"availabilityZone,omitempty"`
    VirtualNetwork                 *MsgAzureNetwork `json:"virtualNetwork,omitempty"`
}

type MsgAzureNetwork struct {
    SubnetId                  *string `json:"subnetId,omitempty"`
    NetworkName               *string `json:"networkName,omitempty"`
    NetworkAddressDetails     *MsgAzureDestinationInfoNic `json:"networkAddressDetails,omitempty"`
...
type MsgAzureDestinationInfoNic struct {
    SubnetId              *string `json:"subnetId,omitempty"`
    PublicIpAddress       *string `json:"publicIpAddress,omitempty"`
    PublicIpAddressId     *string `json:"publicIpAddressId,omitempty"`
    NetworkId             *string `json:"networkId,omitempty"`
...
type MsgSecurityGroup struct {
    Name     *string `json:"name,omitempty"`
    Id       *string `json:"id,omitempty"`
}

type MsgCreateReplicationGroupAzureRequest struct {
    RecoveryTarget                 *MsgIdName `json:"recoveryTarget,omitempty"`
    FrequencyInMinutes             *int `json:"frequencyInMinutes,omitempty"`
    Name                           *string `json:"name,omitempty"`
    Storage[]                      MsgStorageCopyCreateSet `json:"storage,omitempty"`
    SourceHypervisor               *MsgIdName `json:"sourceHypervisor,omitempty"`
    Vms[]                          MsgNameGUIDSet `json:"vms,omitempty"`
    OverrideReplicationOptions[]   MsgOverrideReplicationOptionsAzureCreateSet `json:"overrideReplicationOptions,omitempty"`
    AdvancedOptions                *MsgReplicationGroupAdvOptionsAzure `json:"advancedOptions,omitempty"`
    DestVendor                     *string `json:"destVendor,omitempty"`
}

type MsgOverrideReplicationOptionsAzureCreateSet struct {
    ResourceGroup          *string `json:"resourceGroup,omitempty"`
    SourceVM               *MsgNameGUID `json:"sourceVM,omitempty"`
    ...
    StorageAccount         *string `json:"storageAccount,omitempty"`
    PrivateIPaddress       *string `json:"privateIPaddress,omitempty"`
    VirtualNetwork[]       MsgNetworkSubnetSet `json:"virtualNetwork,omitempty"`
    CreatePublicIP         *bool `json:"createPublicIP,omitempty"`
    PublicIPaddressID      *string `json:"publicIPaddressID,omitempty"`
    RestoreAsManagedVM     *bool `json:"restoreAsManagedVM,omitempty"`
    Region                 *string `json:"region,omitempty"`
...
type MsgNetworkSubnetSet struct {
    SubnetId     *string `json:"subnetId,omitempty"`
    Network      *string `json:"network,omitempty"`
}

type MsgCreateReplicationGroupAzureResponse struct {
    Name     *string `json:"name,omitempty"`
    Id       *int `json:"id,omitempty"`
}
...
type MsgGetUserGroupDetailsResponse struct {
    ...
    MultiCommcellUserGroupSyncType            *string `json:"multiCommcellUserGroupSyncType,omitempty"`
    GUID                                      *string `json:"GUID,omitempty"`
    AllowMultipleCompanyMembers               *bool `json:"allowMultipleCompanyMembers,omitempty"`
    GlobalConfigInfo                          *MsgGlobalConfigInfo `json:"globalConfigInfo,omitempty"`
...
type MsgGlobalConfigInfo struct {
    ScopeFilterQuery        *string `json:"scopeFilterQuery,omitempty"`
    Companies[]             MsgGlobalConfigCompanyInfoSet `json:"companies,omitempty"`
    ApplyOnAllCommCells     *bool `json:"applyOnAllCommCells,omitempty"`
    Commcells[]             MsgGlobalConfigCommcellInfoSet `json:"commcells,omitempty"`
...
type MsgCreateWorkloadProtectionGroupAWSRequest struct {
    CloudConnection                *MsgIdName `json:"cloudConnection,omitempty"`
    Workloads[]                    MsgProtectionGroupWorkloadSet `json:"workloads,omitempty"`
    AllCloudAccounts               *bool `json:"allCloudAccounts,omitempty"`
    Type                           *string `json:"type,omitempty"`
...
type MsgCreateWorkloadProtectionGroupAWSResponse struct {
    Name     *string `json:"name,omitempty"`
    Id       *int `json:"id,omitempty"`
}
...
type MsgPathSet struct {
    ...
    SavedCredentials          *MsgIdName `json:"savedCredentials,omitempty"`
    SharedBackupLocations[]   MsgSharedBackupLocationSet `json:"sharedBackupLocations,omitempty"`
}

type MsgSharedBackupLocationSet struct {
    SavedCredentials     *MsgIdName `json:"savedCredentials,omitempty"`
    SharedPath           *MsgSharedPath `json:"sharedPath,omitempty"`
    MountPathId          *int `json:"mountPathId,omitempty"`
}

type MsgSharedPath struct {
    OsType              *string `json:"osType,omitempty"`
...
type MsgCreateDCPlanRequest struct {
    Schedule            *MsgDCPlanJobSchedule `json:"schedule,omitempty"`
    ContentIndexing     *MsgDCPlanCIpolicy `json:"contentIndexing,omitempty"`
    ThreatIndicator     *MsgThreatIndicatorPolicy `json:"threatIndicator,omitempty"`
    Application         *string `json:"application,omitempty"`
    IndexServer         *MsgIdName `json:"indexServer,omitempty"`
    ThreatAnalysis      *bool `json:"threatAnalysis,omitempty"`
    Name                *string `json:"name,omitempty"`
    EntityDetection     *MsgDCPlanEEPolicy `json:"entityDetection,omitempty"`
    ContentAnalyzer[]   MsgIdNameSet `json:"contentAnalyzer,omitempty"`
}

type MsgDCPlanJobSchedule struct {
    PolicyId       *int `json:"policyId,omitempty"`
    Name           *string `json:"name,omitempty"`
    Pattern        *MsgContentIndexingFrequencyPattern `json:"pattern,omitempty"`
    ScheduleId     *int `json:"scheduleId,omitempty"`
}

type MsgContentIndexingFrequencyPattern struct {
...
type MsgDCPlanCIpolicy struct {
    FileFilters              *MsgDCPlanCIFileFilters `json:"fileFilters,omitempty"`
    CopyPrecedence           *int `json:"copyPrecedence,omitempty"`
    SearchType               *string `json:"searchType,omitempty"`
    ContentLanguage          *string `json:"contentLanguage,omitempty"`
    ExactSearch              *bool `json:"exactSearch,omitempty"`
    BackupCopy[]             MsgDCBackupCopySet `json:"backupCopy,omitempty"`
    ExtractTextFromImage     *bool `json:"extractTextFromImage,omitempty"`
}

type MsgDCPlanCIFileFilters struct {
    IncludeDocTypes     *string `json:"includeDocTypes,omitempty"`
    ExcludePaths[]      string `json:"excludePaths,omitempty"`
    MinDocSize          *int `json:"minDocSize,omitempty"`
    MaxDocSize          *int `json:"maxDocSize,omitempty"`
}

type MsgDCBackupCopySet struct {
    CopyId            *int `json:"copyId,omitempty"`
    StoragePoolId     *int `json:"storagePoolId,omitempty"`
}

type MsgThreatIndicatorPolicy struct {
    ThreatDetection            *MsgThreatDetectionPolicy `json:"threatDetection,omitempty"`
    ThreatNexus                *MsgThreatNexusPolicy `json:"threatNexus,omitempty"`
    ThreatScan                 *MsgThreatScanPolicy `json:"threatScan,omitempty"`
    AccessNodesInfo            *MsgAccessNodesInfo `json:"accessNodesInfo,omitempty"`
    CorrelationPolicyRules     *MsgCorrelationPolicyRule `json:"correlationPolicyRules,omitempty"`
    EnableSmartScanning        *bool `json:"enableSmartScanning,omitempty"`
}

type MsgThreatDetectionPolicy struct {
    BackupSize        *bool `json:"backupSize,omitempty"`
    CanaryFile        *bool `json:"canaryFile,omitempty"`
    FileExtension     *bool `json:"fileExtension,omitempty"`
    FileActivity      *bool `json:"fileActivity,omitempty"`
    FileType          *bool `json:"fileType,omitempty"`
}

type MsgThreatNexusPolicy struct {
    NetworkAndDataSecurity     *MsgNetworkAndDataSecurity `json:"networkAndDataSecurity,omitempty"`
    Soar                       *MsgSOAR `json:"soar,omitempty"`
    Cspm_dspm                  *MsgCSPM_DSPM `json:"cspm_dspm,omitempty"`
}

type MsgNetworkAndDataSecurity struct {
    Netskope        *bool `json:"netskope,omitempty"`
    Darktrace       *bool `json:"darktrace,omitempty"`
    Crowdstrike     *bool `json:"crowdstrike,omitempty"`
}

type MsgSOAR struct {
    PaloAlto_XSOAR     *bool `json:"paloAlto_XSOAR,omitempty"`
    MsSentinel         *bool `json:"msSentinel,omitempty"`
    Splunk             *bool `json:"splunk,omitempty"`
}

type MsgCSPM_DSPM struct {
    Acante     *bool `json:"acante,omitempty"`
    Dasera     *bool `json:"dasera,omitempty"`
}

type MsgThreatScanPolicy struct {
    YaraRules[]              MsgIdNameSet `json:"yaraRules,omitempty"`
    YaraRule                 *bool `json:"yaraRule,omitempty"`
    IocRules[]               MsgIdNameSet `json:"iocRules,omitempty"`
    FileDataAnalysis         *bool `json:"fileDataAnalysis,omitempty"`
    ThreatAnalysis           *bool `json:"threatAnalysis,omitempty"`
    UseCommvaultHashFeed     *bool `json:"useCommvaultHashFeed,omitempty"`
    UseCustomHashFeed        *bool `json:"useCustomHashFeed,omitempty"`
}

type MsgAccessNodesInfo struct {
    AccessNodesGroup     *MsgIdName `json:"accessNodesGroup,omitempty"`
    AccessNodes[]        MsgIdNameSet `json:"accessNodes,omitempty"`
}

type MsgCorrelationPolicyRule struct {
    ThreatDetection     *MsgThreatDetectionCorrelationRule `json:"threatDetection,omitempty"`
    ThreatNexus         *MsgThreatNexusCorrelationRule `json:"threatNexus,omitempty"`
    ThreatScan          *MsgThreatScanCorrelationRule `json:"threatScan,omitempty"`
}

type MsgThreatDetectionCorrelationRule struct {
    UseLastJobStatus     *bool `json:"useLastJobStatus,omitempty"`
    MinDays              *int `json:"minDays,omitempty"`
}

type MsgThreatNexusCorrelationRule struct {
    EnableThreatNexus     *bool `json:"enableThreatNexus,omitempty"`
    MinDays               *int `json:"minDays,omitempty"`
}

type MsgThreatScanCorrelationRule struct {
    MaxDays              *int `json:"maxDays,omitempty"`
    UseLastJobStatus     *bool `json:"useLastJobStatus,omitempty"`
    MinDays              *int `json:"minDays,omitempty"`
}

type MsgDCPlanEEPolicy struct {
    Entities[]          MsgIdNameSet `json:"entities,omitempty"`
    Classifiers[]       MsgIdNameSet `json:"classifiers,omitempty"`
    CopyPrecendence     *int `json:"copyPrecendence,omitempty"`
}

type MsgGetBlackoutWindowDetailsResponse struct {
    DoNotSubmitJob       *bool `json:"doNotSubmitJob,omitempty"`
    AllDays[]            MsgDaysAndTimesSet `json:"allDays,omitempty"`
    BetweenDates         *MsgStartEnd `json:"betweenDates,omitempty"`
...
type MsgDaysAndTimesSet struct {
    Days[]   string `json:"days,omitempty"`
    Time     *MsgStartEnd `json:"time,omitempty"`
}

type MsgStartEnd struct {
    Start     *int64 `json:"start,omitempty"`
    End       *int64 `json:"end,omitempty"`
}

type MsgModifyBlackoutWindowRequest struct {
    DoNotSubmitJob       *bool `json:"doNotSubmitJob,omitempty"`
    AllDays[]            MsgDaysAndTimesSet `json:"allDays,omitempty"`
    BetweenDates         *MsgStartEnd `json:"betweenDates,omitempty"`
    NewName              *string `json:"newName,omitempty"`
...
type MsgModifyBlackoutWindowResponse struct {
    ErrorMessage     *string `json:"errorMessage,omitempty"`
    ErrorCode        *int `json:"errorCode,omitempty"`
}

type MsgCreateBlackoutWindowRequest struct {
    DoNotSubmitJob       *bool `json:"doNotSubmitJob,omitempty"`
    AllDays[]            MsgDaysAndTimesSet `json:"allDays,omitempty"`
    BetweenDates         *MsgStartEnd `json:"betweenDates,omitempty"`
    Weeks[]              string `json:"weeks,omitempty"`
...
type MsgCreateBlackoutWindowResponse struct {
    Name     *string `json:"name,omitempty"`
    Id       *int `json:"id,omitempty"`
}

type MsgDeleteBlackoutWindowResponse struct {
    ErrorMessage     *string `json:"errorMessage,omitempty"`
    ErrorCode        *int `json:"errorCode,omitempty"`
}
...
type MsgGetCredentialDetailsAzureRequest struct {
    VendorType      *string `json:"vendorType,omitempty"`
...
type MsgGetCredentialDetailsAWSRequest struct {
    VendorType          *string `json:"vendorType,omitempty"`
    AccountType         *string `json:"accountType,omitempty"`
    Name                *string `json:"name,omitempty"`
    AccessKeyId         *string `json:"accessKeyId,omitempty"`
...
type MsgGetCredentialDetailsAWSWithRoleArnRequest struct {
    VendorType      *string `json:"vendorType,omitempty"`
    AccountType     *string `json:"accountType,omitempty"`
    Name            *string `json:"name,omitempty"`
    Password        *string `json:"password,omitempty"`
...
type MsgGetCredentialDetailsAzureWithTenantIdRequest struct {
    VendorType            *string `json:"vendorType,omitempty"`
    AccountType           *string `json:"accountType,omitempty"`
    Name                  *string `json:"name,omitempty"`
...
type MsgServerPlanSettings struct {
    ...
    DeviceStreams                 *int `json:"deviceStreams,omitempty"`
    UseForCloudNative             *bool `json:"useForCloudNative,omitempty"`
...
type MsgServerPlanRPO struct {
    DoNotSubmitJobForFullBackupWindow     *bool `json:"doNotSubmitJobForFullBackupWindow,omitempty"`
    ...
    DoNotSubmitJobForBackupWindow         *bool `json:"doNotSubmitJobForBackupWindow,omitempty"`
}
...
type MsgSLAOptions struct {
    ...
    LogSLAMinutes           *int `json:"logSLAMinutes,omitempty"`
...
type MsgPlanScheduleSet struct {
    ...
    TaskOperationType                 *string `json:"taskOperationType,omitempty"`
...
type MsgScheduleOption struct {
    ...
    LogsDiskUtilizationPercent     *int `json:"logsDiskUtilizationPercent,omitempty"`
    MinBackupIntervalInMins        *int `json:"minBackupIntervalInMins,omitempty"`
    LogFilesThreshold              *int `json:"logFilesThreshold,omitempty"`
    DeleteLogsByAppLvlConfig       *bool `json:"deleteLogsByAppLvlConfig,omitempty"`
    CommitFrequencyInHours         *int `json:"commitFrequencyInHours,omitempty"`
    JobRunningTimeInMins           *int `json:"jobRunningTimeInMins,omitempty"`
    RetentionOption                *MsgRetentionOption `json:"retentionOption,omitempty"`
    AutoConvertBackupType          *bool `json:"autoConvertBackupType,omitempty"`
    O365ItemSelectionOption        *string `json:"o365ItemSelectionOption,omitempty"`
    UseDiskCacheForLogBackups      *bool `json:"useDiskCacheForLogBackups,omitempty"`
}

type MsgRetentionOption struct {
    RetentionType              *string `json:"retentionType,omitempty"`
    RetentionPeriodDays        *int `json:"retentionPeriodDays,omitempty"`
    ApplyRetentionOn           *string `json:"applyRetentionOn,omitempty"`
    RetentionStorageCopies[]   MsgRetentionStorageCopiesSet `json:"retentionStorageCopies,omitempty"`
}

type MsgRetentionStorageCopiesSet struct {
    CopyId              *int `json:"copyId,omitempty"`
    StoragePolicyId     *int `json:"storagePolicyId,omitempty"`
}
...
type MsgSchedulePattern struct {
    ...
    DayOfMonth                    *int `json:"dayOfMonth,omitempty"`
    ScheduleFrequencyType         *string `json:"scheduleFrequencyType,omitempty"`
    JobStaggerDurationInMins      *int `json:"jobStaggerDurationInMins,omitempty"`
    StartTime                     *int `json:"startTime,omitempty"`
...
type MsgPlanBackupDestinationSet struct {
    ...
    IndelibleComplianceLock             *bool `json:"indelibleComplianceLock,omitempty"`
    CopyPrecedence                      *int `json:"copyPrecedence,omitempty"`
    ...
    StoragePoolTypeForCopy              *string `json:"storagePoolTypeForCopy,omitempty"`
    IsDefault                           *bool `json:"isDefault,omitempty"`
    Mappings[]                          MsgSnapshotCopyMappingSet `json:"mappings,omitempty"`
    IsSnapCopy                          *bool `json:"isSnapCopy,omitempty"`
    IsSourceCatalog                     *bool `json:"isSourceCatalog,omitempty"`
    ...
    DataRetentionLockDays               *int `json:"dataRetentionLockDays,omitempty"`
}

type MsgStoragePool struct {
    DeviceType              *MsgDeviceType `json:"deviceType,omitempty"`
...
type MsgSnapshotCopyMappingSet struct {
    ...
    Subclients[]     MsgIdNameSet `json:"subclients,omitempty"`
...
type MsgPlanSnapshotOptions struct {
    ...
    BackupCopyOptions          *MsgBackupCopyOptions `json:"backupCopyOptions,omitempty"`
    SyncError                  *string `json:"syncError,omitempty"`
    EnableBackupCopy           *bool `json:"enableBackupCopy,omitempty"`
    EnableSnapCatalog          *bool `json:"enableSnapCatalog,omitempty"`
    DeferredCatalogOptions     *MsgdeferredCatalogOptions `json:"deferredCatalogOptions,omitempty"`
...
type MsgBackupCopyOptions struct {
    BackupFullToCopy           *string `json:"backupFullToCopy,omitempty"`
    EnableAlert                *bool `json:"enableAlert,omitempty"`
    BackupTypeToCopy           *string `json:"backupTypeToCopy,omitempty"`
    AlertInHours               *int `json:"alertInHours,omitempty"`
    SkipAfterThresholdDays     *int `json:"skipAfterThresholdDays,omitempty"`
    Action                     *string `json:"action,omitempty"`
    StartTime                  *int `json:"startTime,omitempty"`
}

type MsgdeferredCatalogOptions struct {
    BackupFullToCopy     *string `json:"backupFullToCopy,omitempty"`
    BackupTypeToCopy     *string `json:"backupTypeToCopy,omitempty"`
    StartTime            *int `json:"startTime,omitempty"`
}
...
type MsgModifyPlanRequest struct {
    ...
    NewName                             *string `json:"newName,omitempty"`
    BackupDestinations[]                MsgPlanBackupDestinationDetailsSet `json:"backupDestinations,omitempty"`
    OverrideRestrictions                *MsgPlanOverrideSettings `json:"overrideRestrictions,omitempty"`
...
type MsgPlanBackupDestinationDetailsSet struct {
    General                   *MsgPlanBackupDestinationGeneralInfo `json:"general,omitempty"`
    Mappings[]                MsgSnapshotCopyMappingSet `json:"mappings,omitempty"`
    PlanBackupDestination     *MsgIdName `json:"planBackupDestination,omitempty"`
    RetentionRules            *MsgPlanBackupDestinationRetentionRuleInfo `json:"retentionRules,omitempty"`
    GlobalConfigInfo          *MsgGlobalConfigInfo `json:"globalConfigInfo,omitempty"`
    Region                    *MsgIdNameDisplayName `json:"region,omitempty"`
    Plan                      *MsgIdName `json:"plan,omitempty"`
    Configurable              *bool `json:"configurable,omitempty"`
    BackupType                *MsgPlanBackupDestinationBackupTypeInfo `json:"backupType,omitempty"`
    SnapOptions               *MsgPlanBackupDestinationSnapOptions `json:"snapOptions,omitempty"`
}

type MsgPlanBackupDestinationGeneralInfo struct {
    IsMirrorCopy                        *bool `json:"isMirrorCopy,omitempty"`
    IsImmutableSnapCopy                 *bool `json:"isImmutableSnapCopy,omitempty"`
    IndelibleComplianceLock             *bool `json:"indelibleComplianceLock,omitempty"`
    IsAirgapCopy                        *bool `json:"isAirgapCopy,omitempty"`
    CopyPrecedence                      *int `json:"copyPrecedence,omitempty"`
    IsCopyInMaintenanceMode             *bool `json:"isCopyInMaintenanceMode,omitempty"`
    Storage                             *MsgStoragePool `json:"storage,omitempty"`
    Source                              *MsgIdName `json:"source,omitempty"`
    FinancialCalendar                   *MsgFinancialCalendar `json:"financialCalendar,omitempty"`
...
type MsgFinancialCalendar struct {
    CalendarName              *string `json:"calendarName,omitempty"`
    MonthStartsOn             *int `json:"monthStartsOn,omitempty"`
    MinutesSinceDayStarts     *int `json:"minutesSinceDayStarts,omitempty"`
    CalendarId                *int `json:"calendarId,omitempty"`
    StartingMonthOfYear       *string `json:"startingMonthOfYear,omitempty"`
    WeekStartsOn              *string `json:"weekStartsOn,omitempty"`
}

type MsgPlanBackupDestinationRetentionRuleInfo struct {
    RetentionPeriodDays                 *int `json:"retentionPeriodDays,omitempty"`
    SkipAgingEnableDateTime             *int64 `json:"skipAgingEnableDateTime,omitempty"`
    InheritRetentionForExistingJobs     *bool `json:"inheritRetentionForExistingJobs,omitempty"`
    ExtendedRetentionRules              *MsgExtendedRetentionRules `json:"extendedRetentionRules,omitempty"`
    RetentionRuleType                   *string `json:"retentionRuleType,omitempty"`
    SnapRecoveryPoints                  *int `json:"snapRecoveryPoints,omitempty"`
    EnableDataAging                     *bool `json:"enableDataAging,omitempty"`
    FinancialCalendar                   *MsgFinancialCalendar `json:"financialCalendar,omitempty"`
    SkipAgingEnableTimeZone             *int64 `json:"skipAgingEnableTimeZone,omitempty"`
    UseExtendedRetentionRules           *bool `json:"useExtendedRetentionRules,omitempty"`
    FullBackupTypesToBeRetained         *string `json:"fullBackupTypesToBeRetained,omitempty"`
    OverrideRetentionSettings           *bool `json:"overrideRetentionSettings,omitempty"`
}

type MsgPlanBackupDestinationBackupTypeInfo struct {
    BackupTypesCopiedFrom     *int `json:"backupTypesCopiedFrom,omitempty"`
    BackupTypesToCopy         *string `json:"backupTypesToCopy,omitempty"`
    FinancialCalendar         *MsgFinancialCalendar `json:"financialCalendar,omitempty"`
    FullBackupTypesToCopy     *string `json:"fullBackupTypesToCopy,omitempty"`
}

type MsgPlanBackupDestinationSnapOptions struct {
    IsSourceCatalog             *bool `json:"isSourceCatalog,omitempty"`
    SnapOperationsSupported     *int `json:"snapOperationsSupported,omitempty"`
    IsSourceBackupCopy          *bool `json:"isSourceBackupCopy,omitempty"`
}
...
type MsgCreatePlanBackupDestinationSet struct {
    ...
    SnapRecoveryPoints             *int `json:"snapRecoveryPoints,omitempty"`
    SourceCopy                     *MsgIdName `json:"sourceCopy,omitempty"`
    StoragePolicy                  *MsgIdName `json:"storagePolicy,omitempty"`
    FullBackupTypesToCopy          *string `json:"fullBackupTypesToCopy,omitempty"`
    UseExtendedRetentionRules      *bool `json:"useExtendedRetentionRules,omitempty"`
    BackupStartTime                *int `json:"backupStartTime,omitempty"`
    OverrideRetentionSettings      *bool `json:"overrideRetentionSettings,omitempty"`
...
type MsgCreateServerPlanResponse struct {
    Plan       *MsgIdNameGUID `json:"plan,omitempty"`
...
type MsgCreateHypervisorAWSRequest struct {
    ForceAccessNodeRegion           *bool `json:"forceAccessNodeRegion,omitempty"`
    EnableCloudConfigProtection     *bool `json:"enableCloudConfigProtection,omitempty"`
    SkipCredentialValidation        *bool `json:"skipCredentialValidation,omitempty"`
    EtcdProtection                  *MsgEtcdProtectionItem `json:"etcdProtection,omitempty"`
    Credentials                     *MsgIdName `json:"credentials,omitempty"`
    Name                            *string `json:"name,omitempty"`
    ...
    IsSTSAssumeRole                 *bool `json:"isSTSAssumeRole,omitempty"`
}
...
type MsghypervisorSettings struct {
    ...
    TimeZone                     *MsgIdName `json:"timeZone,omitempty"`
    EnableRegionBasedBackups     *bool `json:"enableRegionBasedBackups,omitempty"`
    CustomAttributes[]           MsghypervisorCustomAttributeSet `json:"customAttributes,omitempty"`
}
...
type MsghypervisorCustomAttributeSet struct {
    Type      *int `json:"type,omitempty"`
    Value     *string `json:"value,omitempty"`
}
...
type MsgupdateHypervisorAWSResponse struct {
    ...
    Instance                       *MsgIdName `json:"instance,omitempty"`
    CreationTime                   *int `json:"creationTime,omitempty"`
    Credentials                    *MsgVMExistingCredential `json:"credentials,omitempty"`
    HypervisorCommonProperties     *MsghypervisorCommonProps `json:"hypervisorCommonProperties,omitempty"`
    DisplayName                    *string `json:"displayName,omitempty"`
    DefaultFBRUnixMediaAgent       *MsgIdName `json:"defaultFBRUnixMediaAgent,omitempty"`
    IsProtectionGroupGenerated     *bool `json:"isProtectionGroupGenerated,omitempty"`
    HypervisorType                 *string `json:"hypervisorType,omitempty"`
    UseHostedInfrastructure        *bool `json:"useHostedInfrastructure,omitempty"`
    ProtectionGroup                *MsgIdName `json:"protectionGroup,omitempty"`
    ...
    Status                         *string `json:"status,omitempty"`
    VmGroups[]                     MsgIdNameStatusSet `json:"vmGroups,omitempty"`
}
...
type MsghypervisorCommonProps struct {
    ...
    IsSnapshotV2                    *bool `json:"isSnapshotV2,omitempty"`
}
...
type MsgCreateHypervisorAzureRequest struct {
    ...
    WorkloadRegion                  *MsgIdName `json:"workloadRegion,omitempty"`
    WorkloadType                    *string `json:"workloadType,omitempty"`
    ManagedIdentityAuthType         *string `json:"managedIdentityAuthType,omitempty"`
    IsAuthorizedUsingMTA            *bool `json:"isAuthorizedUsingMTA,omitempty"`
    HypervisorType                  *string `json:"hypervisorType,omitempty"`
    SubscriptionId                  *string `json:"subscriptionId,omitempty"`
    UseManagedIdentity              *bool `json:"useManagedIdentity,omitempty"`
    UseSharedInfrastructure         *bool `json:"useSharedInfrastructure,omitempty"`
}
...
type MsgPOSTFirewallTopologyRequest struct {
    FirewallGroups[]     MsgFirewallTopologyGroupsSet `json:"firewallGroups,omitempty"`
    TopologyName         *string `json:"topologyName,omitempty"`
    ClientType           *string `json:"clientType,omitempty"`
    UseWildCardProxy     *bool `json:"useWildCardProxy,omitempty"`
    TopologyType         *string `json:"topologyType,omitempty"`
    TunnelsPerRoute      *int `json:"tunnelsPerRoute,omitempty"`
    TunnelProtocol       *string `json:"tunnelProtocol,omitempty"`
    EncryptTraffic       *bool `json:"encryptTraffic,omitempty"`
}

type MsgFirewallTopologyGroupsSet struct {
    GroupType           *string `json:"groupType,omitempty"`
    ClientGroupId       *int `json:"clientGroupId,omitempty"`
    AdvancedOptions     *MsgFirewallGroupAdvancedOptions `json:"advancedOptions,omitempty"`
    Mnemonic            *string `json:"mnemonic,omitempty"`
}

type MsgFirewallGroupAdvancedOptions struct {
    KeepAliveInterval     *int `json:"keepAliveInterval,omitempty"`
    TunnelPort            *int `json:"tunnelPort,omitempty"`
}

type MsgPOSTFirewallTopologyResponse struct {
    TopologyId     *int `json:"topologyId,omitempty"`
    Error          *MsgGenericResp `json:"error,omitempty"`
}

type MsgGETFirewallTopologyDetailsResponse struct {
    TopologyDetails     *MsgFirewallTopologyDetails `json:"topologyDetails,omitempty"`
}

type MsgFirewallTopologyDetails struct {
    FirewallGroups[]     MsgFirewallTopologyGroupsSet `json:"firewallGroups,omitempty"`
    ClientType           *string `json:"clientType,omitempty"`
    UseWildCardProxy     *bool `json:"useWildCardProxy,omitempty"`
    TopologyType         *string `json:"topologyType,omitempty"`
    TunnelsPerRoute      *int `json:"tunnelsPerRoute,omitempty"`
    Topology             *MsgIdName `json:"topology,omitempty"`
    TunnelProtocol       *string `json:"tunnelProtocol,omitempty"`
    EncryptTraffic       *bool `json:"encryptTraffic,omitempty"`
}

type MsgDELETEFirewallTopologyResponse struct {
    ErrorMessage     *string `json:"errorMessage,omitempty"`
    ErrorCode        *int `json:"errorCode,omitempty"`
}

type MsgPUTFirewallTopologyRequest struct {
    FirewallGroups[]     MsgFirewallTopologyGroupsSet `json:"firewallGroups,omitempty"`
    TopologyName         *string `json:"topologyName,omitempty"`
    ClientType           *string `json:"clientType,omitempty"`
    UseWildCardProxy     *bool `json:"useWildCardProxy,omitempty"`
...
type MsgPUTFirewallTopologyResponse struct {
    ErrorMessage     *string `json:"errorMessage,omitempty"`
    ErrorCode        *int `json:"errorCode,omitempty"`
}

type MsgCreateRegionRequest struct {
    Name                 *string `json:"name,omitempty"`
    GlobalConfigInfo     *MsgCreateGlobalConfigInfo `json:"globalConfigInfo,omitempty"`
    Locations[]          MsgLocationDetailsSet `json:"locations,omitempty"`
    Type                 *string `json:"type,omitempty"`
}

type MsgLocationDetailsSet struct {
...
type MsgGetRegionDetailsResponse struct {
    RegionType                     *string `json:"regionType,omitempty"`
    DisplayName                    *string `json:"displayName,omitempty"`
    Name                           *string `json:"name,omitempty"`
    GlobalConfigInfo               *MsgGlobalConfigInfo `json:"globalConfigInfo,omitempty"`
    Locations[]                    MsgLocationDetailsWithZoneSet `json:"locations,omitempty"`
    Id                             *int `json:"id,omitempty"`
    AssociatedRegionBasedPlans     *MsgAssociatedRegionBasedPlans `json:"associatedRegionBasedPlans,omitempty"`
    AssociatedServers              *MsgRegionAssociatedServers `json:"associatedServers,omitempty"`
}

type MsgLocationDetailsWithZoneSet struct {
    Continent     *string `json:"continent,omitempty"`
    Country       *string `json:"country,omitempty"`
    City          *string `json:"city,omitempty"`
    Zone          *MsgIdName `json:"zone,omitempty"`
    Latitude      *float64 `json:"latitude,omitempty"`
    State         *string `json:"state,omitempty"`
    Longitude     *float64 `json:"longitude,omitempty"`
}

type MsgAssociatedRegionBasedPlans struct {
    PlansCount     *int `json:"plansCount,omitempty"`
    Plans[]        MsgAssociatedRegionBasedPlansListSet `json:"plans,omitempty"`
}

type MsgAssociatedRegionBasedPlansListSet struct {
    Type                  *string `json:"type,omitempty"`
    Plan                  *MsgIdName `json:"plan,omitempty"`
    AssociatedServers     *int `json:"associatedServers,omitempty"`
}

type MsgRegionAssociatedServers struct {
    Servers[]        MsgRegionAssociatedServersListSet `json:"servers,omitempty"`
    ServersCount     *int `json:"serversCount,omitempty"`
}

type MsgRegionAssociatedServersListSet struct {
    Server        *MsgIdName `json:"server,omitempty"`
    Latitude      *float64 `json:"latitude,omitempty"`
    Longitude     *float64 `json:"longitude,omitempty"`
}
...
type MsgUpdateRegionRequest struct {
    NewName                    *string `json:"newName,omitempty"`
    Locations[]                MsgLocationDetailsWithZoneSet `json:"locations,omitempty"`
...
type MsgGetCloudConnectionDetailsResponse struct {
    CloudConnection     *MsgCloudConnectionDetails `json:"cloudConnection,omitempty"`
}

type MsgCloudConnectionDetails struct {
    DisplayName              *string `json:"displayName,omitempty"`
    Name                     *string `json:"name,omitempty"`
    Id                       *int `json:"id,omitempty"`
    CloudType                *string `json:"cloudType,omitempty"`
    ...
    Credentials              *MsgCloudConnectionCredentialsInfo `json:"credentials,omitempty"`
    CloudSpecificDetails     *MsgCloudSpecificCloudConnectionDetails `json:"cloudSpecificDetails,omitempty"`
    AccessNodes[]            MsgAccessNodeItemSet `json:"accessNodes,omitempty"`
    DiscoveryStatus          *string `json:"discoveryStatus,omitempty"`
    LastDiscoveryDetails     *MsgDiscoveryOperationDetails `json:"lastDiscoveryDetails,omitempty"`
    DiscoveredAccounts[]     MsgCloudAccountDetailsSet `json:"discoveredAccounts,omitempty"`
}

type MsgCloudConnectionCredentialsInfo struct {
    CredentialType     *string `json:"credentialType,omitempty"`
    CredentialId       *int `json:"credentialId,omitempty"`
}

type MsgCloudSpecificCloudConnectionDetails struct {
    GoogleCloud     *MsgGCPCloudConnectionConfiguration `json:"googleCloud,omitempty"`
    Aws             *MsgAWSCloudConnectionDetails `json:"aws,omitempty"`
    Azure           *MsgAzureCloudConnectionConfiguration `json:"azure,omitempty"`
}

type MsgGCPCloudConnectionConfiguration struct {
    Projects[]              MsgCloudAccountSet `json:"projects,omitempty"`
    DiscoverAllProjects     *bool `json:"discoverAllProjects,omitempty"`
    ServiceAccount          *string `json:"serviceAccount,omitempty"`
}

type MsgAWSCloudConnectionDetails struct {
    Regions                       *string `json:"regions,omitempty"`
    OrganizationConfiguration     *MsgAWSCloudConnectionOrganizationConfiguration `json:"organizationConfiguration,omitempty"`
    IamRoleAccountId              *string `json:"iamRoleAccountId,omitempty"`
    OrganizationDetails           *MsgAWSOrganizationDetails `json:"organizationDetails,omitempty"`
}

type MsgAWSCloudConnectionOrganizationConfiguration struct {
    OwnerDetectionConfiguration     *MsgAWSCloudConnectionOwnerDiscoveryConfiguration `json:"ownerDetectionConfiguration,omitempty"`
    EnableOwnerDetection            *bool `json:"enableOwnerDetection,omitempty"`
    Content                         *MsgAWSCloudConnectionOrganizationContent `json:"content,omitempty"`
}

type MsgAWSCloudConnectionOwnerDiscoveryConfiguration struct {
    IdentityCenterRegion     *string `json:"identityCenterRegion,omitempty"`
    OwnerPermissionSets[]    string `json:"ownerPermissionSets,omitempty"`
}

type MsgAWSCloudConnectionOrganizationContent struct {
    DiscoverAllAccounts     *bool `json:"discoverAllAccounts,omitempty"`
    Accounts[]              MsgCloudAccountSet `json:"accounts,omitempty"`
}

type MsgAWSOrganizationDetails struct {
...
type MsgAzureCloudConnectionConfiguration struct {
    Environment                 *string `json:"environment,omitempty"`
    Subscriptions[]             MsgCloudAccountSet `json:"subscriptions,omitempty"`
    TenantName                  *string `json:"tenantName,omitempty"`
    TenantId                    *string `json:"tenantId,omitempty"`
    DiscoverAllSubscription     *bool `json:"discoverAllSubscription,omitempty"`
    IsCustomConfig              *bool `json:"isCustomConfig,omitempty"`
}

type MsgDiscoveryOperationDetails struct {
    EndTime     *int64 `json:"endTime,omitempty"`
    Errors[]    string `json:"errors,omitempty"`
}

type MsgCloudAccountDetailsSet struct {
    Name             *string `json:"name,omitempty"`
    Id               *string `json:"id,omitempty"`
    Uuid             *string `json:"uuid,omitempty"`
    Email            *string `json:"email,omitempty"`
...
type MsgUpdateCloudConnectionRequest struct {
    Credentials                    *MsgCloudConnectionCredentialsInfo `json:"credentials,omitempty"`
    DisplayName                    *string `json:"displayName,omitempty"`
    CloudSpecificConfiguration     *MsgCloudSpecificCloudConnectionConfiguration `json:"cloudSpecificConfiguration,omitempty"`
    AccessNodes[]                  MsgAccessNodeItemSet `json:"accessNodes,omitempty"`
}

type MsgCloudSpecificCloudConnectionConfiguration struct {
    GoogleCloud     *MsgGCPCloudConnectionConfiguration `json:"googleCloud,omitempty"`
    Aws             *MsgAWSCloudConnectionConfiguration `json:"aws,omitempty"`
    Azure           *MsgAzureCloudConnectionConfiguration `json:"azure,omitempty"`
}

type MsgAWSCloudConnectionConfiguration struct {
    Regions                       *string `json:"regions,omitempty"`
    OrganizationConfiguration     *MsgAWSCloudConnectionOrganizationConfiguration `json:"organizationConfiguration,omitempty"`
    IamRoleAccountId              *string `json:"iamRoleAccountId,omitempty"`
}

type MsgCreateCloudConnectionRequest struct {
    Credentials                    *MsgCloudConnectionCredentialsInfo `json:"credentials,omitempty"`
    CloudType                      *string `json:"cloudType,omitempty"`
    CloudSpecificConfiguration     *MsgCloudSpecificCloudConnectionConfiguration `json:"cloudSpecificConfiguration,omitempty"`
    StartDiscoveryJob              *bool `json:"startDiscoveryJob,omitempty"`
    Name                           *string `json:"name,omitempty"`
    AccessNodes[]                  MsgAccessNodeItemSet `json:"accessNodes,omitempty"`
    ConnectionType                 *string `json:"connectionType,omitempty"`
...
type MsgCreateCloudConnectionResponse struct {
    CloudDiscoveryJobId     *int `json:"cloudDiscoveryJobId,omitempty"`
    Name                    *string `json:"name,omitempty"`
    Id                      *int `json:"id,omitempty"`
    Error                   *MsgGenericResp `json:"error,omitempty"`
}
...
type MsgvmGroupSettings struct {
    EncryptionFlag                            *string `json:"encryptionFlag,omitempty"`
    ...
    SnapshotStorageType                       *string `json:"snapshotStorageType,omitempty"`
    JobStartTime                              *int `json:"jobStartTime,omitempty"`
    ...
    CanChangeEncryptionSetting                *bool `json:"canChangeEncryptionSetting,omitempty"`
    ...
    ApplicationCredentials                    *MsgapplicationCredentialInfo `json:"applicationCredentials,omitempty"`
    GuestCredentials                          *MsgguestCredentialInfo `json:"guestCredentials,omitempty"`
    SoftwareCompression                       *string `json:"softwareCompression,omitempty"`
...
type MsgapplicationCredentialInfo struct {
    SavedCredentials     *MsgIdName `json:"savedCredentials,omitempty"`
}
...
type MsgvmDiskFilterSet struct {
    ...
    Children[]            Msg_vmDiskFilterSet `json:"children,omitempty"`
    Name                  *string `json:"name,omitempty"`
    FilterSubResource     *bool `json:"filterSubResource,omitempty"`
...
type Msg_vmDiskFilterSet struct {
    Condition             *string `json:"condition,omitempty"`
    VmName                *string `json:"vmName,omitempty"`
    Name                  *string `json:"name,omitempty"`
    FilterSubResource     *bool `json:"filterSubResource,omitempty"`
...
type MsgDeleteVMGroupResponse struct {
    ErrorCode     *int `json:"errorCode,omitempty"`
    Entity        *MsgvmgroupdeleteEntityResponse `json:"entity,omitempty"`
}

type MsgvmgroupdeleteEntityResponse struct {
...
type MsgUpdateVMGroupRequest struct {
    ...
    ApplicationValidation     *MsgvmAppValidation `json:"applicationValidation,omitempty"`
    Plan                      *MsgIdName `json:"plan,omitempty"`
    RemovePlanAssociation     *bool `json:"removePlanAssociation,omitempty"`
    MeditechSystems           *MsgmeditechPropResp `json:"meditechSystems,omitempty"`
}
