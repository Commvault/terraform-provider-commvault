...
func resourceUserGroup() *schema.Resource {
    return &schema.Resource{
        ...
        Schema: map[string]*schema.Schema{
            "multicommcellusergroupsynctype": {
                Type:        schema.TypeString,
                Optional:    true,
                Computed:    true,
                Description: "[None, InternallyManagedGroup, ExternallyManagedGroup]",
            },
            "name": {
                Type:        schema.TypeString,
                Required:    true,
...
func resourceCreateUserGroup(d *schema.ResourceData, m interface{}) error {
    ...
    var t_multicommcellusergroupsynctype *string
    if val, ok := d.GetOk("multicommcellusergroupsynctype"); ok {
        t_multicommcellusergroupsynctype = handler.ToStringValue(val, false)
    }
    var t_name *string
    ...
    if val, ok := d.GetOk("globalconfiginfo"); ok {
        t_globalconfiginfo = build_usergroup_msgcreateglobalconfiginfo(d, val.([]interface{}))
    }
    ...
    var req = handler.MsgCreateUserGroupRequest{MultiCommcellUserGroupSyncType:t_multicommcellusergroupsynctype, Name:t_name, GlobalConfigInfo:t_globalconfiginfo, Description:t_description, EnforceFSQuota:t_enforcefsquota, QuotaLimitInGB:t_quotalimitingb}
...
func resourceReadUserGroup(d *schema.ResourceData, m interface{}) error {
    ...
    if resp.MultiCommcellUserGroupSyncType != nil {
        d.Set("multicommcellusergroupsynctype", resp.MultiCommcellUserGroupSyncType)
    }
    ...
    if rtn, ok := serialize_usergroup_msgglobalconfiginfo(d, resp.GlobalConfigInfo); ok {
...
func resourceUpdateUserGroup(d *schema.ResourceData, m interface{}) error {
    ...
    var t_multicommcellusergroupsynctype *string
    if d.HasChange("multicommcellusergroupsynctype") {
        val := d.Get("multicommcellusergroupsynctype")
        t_multicommcellusergroupsynctype = handler.ToStringValue(val, false)
    }
...
func build_usergroup_msgcreateglobalconfiginfo(d *schema.ResourceData, r []interface{}) *handler.MsgCreateGlobalConfigInfo {
    if len(r) > 0 && r[0] != nil {
        tmp := r[0].(map[string]interface{})
        ...
        if val, ok := tmp["companies"]; ok {
            t_companies = build_usergroup_msgglobalconfigcompanyinfoset_array(d, val.(*schema.Set).List())
        }
        ...
        if val, ok := tmp["commcells"]; ok {
            t_commcells = build_usergroup_msgglobalconfigcommcellinfoset_array(d, val.(*schema.Set).List())
        }
        var t_scope *string
...
func build_usergroup_msgglobalconfigcommcellinfoset_array(d *schema.ResourceData, r []interface{}) []handler.MsgGlobalConfigCommcellInfoSet {
    if r != nil {
...
func build_usergroup_msgglobalconfigcompanyinfoset_array(d *schema.ResourceData, r []interface{}) []handler.MsgGlobalConfigCompanyInfoSet {
    if r != nil {
...
func serialize_usergroup_msgglobalconfiginfo(d *schema.ResourceData, data *handler.MsgGlobalConfigInfo) ([]map[string]interface{}, bool) {
    ...
    if rtn, ok := serialize_usergroup_msgglobalconfigcompanyinfoset_array(d, data.Companies); ok {
        val[0]["companies"] = rtn
        added = true
    }
    ...
    if rtn, ok := serialize_usergroup_msgglobalconfigcommcellinfoset_array(d, data.Commcells); ok {
        val[0]["commcells"] = rtn
        added = true
    }
    if data.Scope != nil {
...
func serialize_usergroup_msgglobalconfigcommcellinfoset_array(d *schema.ResourceData, data []handler.MsgGlobalConfigCommcellInfoSet) ([]map[string]interface{}, bool) {
...
func serialize_usergroup_msgglobalconfigcompanyinfoset_array(d *schema.ResourceData, data []handler.MsgGlobalConfigCompanyInfoSet) ([]map[string]interface{}, bool) {
